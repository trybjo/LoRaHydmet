// RH_Repeater_ReliableDatagram.h
//
// Author: Mike McCauley (mikem@airspayce.com)
// Copyright (C) 2011 Mike McCauley
// $Id: RH_Repeater_ReliableDatagram.h,v 1.17 2016/04/04 01:40:12 mikem Exp $

#ifndef RH_Repeater_ReliableDatagram_h
#define RH_Repeater_ReliableDatagram_h

// #include <RH_Repeater_Datagram.h> From original
...
/////////////////////////////////////////////////////////////////////
/// \class RH_Repeater_ReliableDatagram RH_Repeater_ReliableDatagram.h <RH_Repeater_ReliableDatagram.h>
/// \brief RH_Repeater_Datagram subclass for sending addressed, acknowledged, retransmitted datagrams.
///
/// Manager class that extends RH_Repeater_Datagram to define addressed, reliable datagrams with acknowledgement and retransmission.
/// Based on RH_Repeater_Datagram, adds flags and sequence numbers. RH_Repeater_ReliableDatagram is reliable in the sense
...
///
/// You can use RH_Repeater_ReliableDatagram to send broadcast messages, with a TO address of RH_BROADCAST_ADDRESS,
...
///
/// RH_Repeater_ReliableDatagram and the underlying drivers always transmit as soon as
/// sendtoWait() is called.  RH_Repeater_ReliableDatagram waits for an acknowledgement,
...
///
/// There is no message queuing or threading in RH_Repeater_ReliableDatagram. 
...
///
class RH_Repeater_ReliableDatagram : public RH_Repeater_Datagram
{
public:
    /// Constructor. 
    /// \param[in] driver The RadioHead driver to use to transport messages.
    /// \param[in] thisAddress The address to assign to this node. Defaults to 0
    RH_Repeater_ReliableDatagram(RHGenericDriver& driver, uint8_t thisAddress = 0);
    ...
    /// \param[in] mySenderAddress The address we want defined as sender.
    ...
    bool sendtoWaitRepeater(uint8_t* buf, uint8_t len, uint8_t address, uint8_t mySenderAddress);
...
protected:
    ...
    void acknowledge(uint8_t id, uint8_t from, uint8_t to);
