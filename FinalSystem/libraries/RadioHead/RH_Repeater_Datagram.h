// RH_Repeater_Datagram.h
// Author: Mike McCauley (mikem@airspayce.com)
// Copyright (C) 2011 Mike McCauley
// $Id: RH_Repeater_Datagram.h,v 1.14 2015/08/12 23:18:51 mikem Exp $

#ifndef RH_Repeater_Datagram_h
#define RH_Repeater_Datagram_h
...
/////////////////////////////////////////////////////////////////////
/// \class RH_Repeater_Datagram RH_Repeater_Datagram.h <RH_Repeater_Datagram.h>
/// \brief Manager class for addressed, unreliable messages
///
/// Every RH_Repeater_Datagram node has an 8 bit address (defaults to 0).
/// Addresses (DEST and SRC) are 8 bit integers with an address of RH_BROADCAST_ADDRESS (0xff) 
/// reserved for broadcast.
///
/// \par Media Access Strategy
///
/// RH_Repeater_Datagram and the underlying drivers always transmit as soon as sendto() is called.
///
/// \par Message Lengths
///
...
///
class RH_Repeater_Datagram
{
public:
    /// Constructor. 
    /// \param[in] driver The RadioHead driver to use to transport messages.
    /// \param[in] thisAddress The address to assign to this node. Defaults to 0
    RH_Repeater_Datagram(RHGenericDriver& driver, uint8_t thisAddress = 0);
    ...
    /// to be accepted by all RH_Repeater_Datagram nodes within range.
